        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 ml-1">
            <input
              ...
              title="Custom color"
            />
            <span className="text-xs text-gray-400 font-mono">{selectedHex}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        {options.labelStyle === 'token' && (
          <p className="text-xs text-gray-400">
            Replaces each PII instance with a consistent token (e.g. [NAME_001]), preserves structure for audit trails and data mapping.
          </p>
        )}
      </div>
        ...
        {options.watermark.enabled && (
          <div className="flex flex-col gap-2 pl-2 border-l-2 border-gray-200">
            <input
              ...
              className="text-sm border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-green-400 max-w-xs"
            />
